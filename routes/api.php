...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::get('/reports/inventory', [ReportController::class, 'inventoryExport']);
    Route::get('/reports/employees', [ReportController::class, 'employeeExport']);
    Route::get('/reports/sales', [ReportController::class, 'salesExport']);
    Route::get('/ai-analytics', [AIAnalyticsController::class, 'getAnalytics']);
});
...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::prefix('accounting')->group(function () {
        ...
        Route::get('/journals', [AccountingController::class, 'getJournals']);
        Route::post('/journals', [AccountingController::class, 'storeJournal']);
        Route::get('/journals/{id}', [AccountingController::class, 'showJournal']);
        Route::put('/journals/{id}', [AccountingController::class, 'updateJournal']);
        Route::delete('/journals/{id}', [AccountingController::class, 'deleteJournal']);
        Route::get('/reports/balance-sheet', [AccountingController::class, 'getBalanceSheet']);
        Route::get('/reports/income-statement', [AccountingController::class, 'getIncomeStatement']);
        Route::get('/reports/trial-balance', [AccountingController::class, 'getTrialBalance']);
        Route::get('/reports/aged-report', [AccountingController::class, 'getAgedReport']);
        Route::get('/reports/cash-flow', [AccountingController::class, 'getCashFlow']);

        Route::get('/stats', [AccountingController::class, 'getDashboardStats']);

        Route::apiResource('invoices', InvoiceController::class);
        Route::apiResource('bills', BillController::class);
        Route::apiResource('budgets', BudgetController::class);
        Route::post('budgets/{id}/refresh', [BudgetController::class, 'refreshActuals']);
    ...
    Route::prefix('pos')->group(function () {
        ...
        Route::get('/sales/{id}/receipt', [SaleController::class, 'getReceipt']);
        ...
        Route::prefix('payment-methods')->group(function () {
            ...
            Route::match(['put', 'post'], '/{id}', [PaymentMethodController::class, 'update']);
